...
public class SecondFragment extends Fragment {
    ...
    public void getFirebaseDatabase(){
        ValueEventListener postListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot postSnapshot: dataSnapshot.getChildren()) {
                    ...
                    //방 1호
                    if(fdfire.equals(fire) && loca.equals("FR1")){
                    ...
                    else if(fdfire.equals("0") && loca.equals("FR1")){
                    ...
                    //방 2호
                    if(fdfire.equals(fire) && loca.equals("FR2")){
                    ...
                    else if(fdfire.equals("0") && loca.equals("FR2")) {
                    ...
                    //방 3호
                    if(fdfire.equals(fire) && loca.equals("FR3")){
                    ...
                    else if(fdfire.equals("0") && loca.equals("FR3")) {
                    ...
                    //방 4호
                    if(fdfire.equals(fire) && loca.equals("FR4")){
                    ...
                    else if(fdfire.equals("0") && loca.equals("FR4")) {
                    ...
                    //좌측 복도
                    if(fdfire.equals(fire) && loca.equals("FR5")){
                    ...
                    else if(fdfire.equals("0") && loca.equals("FR5")) {
                    ...
                    //중앙 복도
                    if(fdfire.equals(fire) && loca.equals("FR6")){
                    ...
                    else if(fdfire.equals("0") && loca.equals("FR6")) {
                    ...
                    //우측 복도
                    if(fdfire.equals(fire) && loca.equals("FR7")){
                    ...
                    else if(fdfire.equals("0") && loca.equals("FR7")) {
                    ...
                    //좌측 계단
                    if(fdfire.equals(fire) && loca.equals("FR8")){
                    ...
                    else if(fdfire.equals("0") && loca.equals("FR8")) {
                    ...
                    //우측 계단
                    if(fdfire.equals(fire) && loca.equals("FR9")){
                    ...
                    else if(fdfire.equals("0") && loca.equals("FR9")) {
        ...
        Query sortbyAge = FirebaseDatabase.getInstance().getReference().child("icom1f").orderByChild(sort);
